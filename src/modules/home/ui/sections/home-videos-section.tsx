...
interface HomeVideosSectionProprs {
  categoryId?: string;
}

export const HomeVideosSection = (props: HomeVideosSectionProprs) => {
  return (
    <Suspense
...
const HomeVideosSectionSuspense = ({ categoryId }: HomeVideosSectionProprs) => {
